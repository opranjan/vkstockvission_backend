...
async function generateUserAgreementBuffer(submission, ipAddress) {
  return new Promise((resolve) => {
    ...
    doc.fill("#fff").font(bold).fontSize(14).text("VKSTOCKVISION", leftMargin, 22);
    doc.font(regular).fontSize(10)
      .text("SEBI Registered Research Analyst", leftMargin, 40)
      .text("Registration No. INH000019831", leftMargin, 52)
  ...
  "i. Research Analyst: VKSTOCKVISION, a SEBI Registered Research Analyst, holding Registration No. INH000019831, with its registered office located  Mumbai, Maharashtra , hereinafter referred to as the 'Research Analyst' or 'RA'.\n\n" +
...
section(
  ...
  "Contact No.: 8000489090\n" +
  "Mail ID: info@vkstockvission.in\n" +
...
doc.font("Helvetica-Bold")
  .fillColor("#1F3B77")
  .fontSize(12)
  .text("VKSTOCKVISION.", footerLeft + footerPadding, footerTop + footerPadding);
